...
export const list33: Word[] = [
  freq(noun('restaurang', 'en', '餐馆；饭店', 'restaurant', 'restaurangen', 'restauranger', 'restaurangerna', [
  ...
  freq(noun('ost', 'en', '奶酪；东方', 'cheese / east', 'osten', 'ostar', 'ostarna', [
    ['Jag köper ost till smörgåsen.', '我给三明治买奶酪。'],
    ['Osten är stark.', '这块奶酪味道冲。'],
    ['Hon har tre ostar i kylen.', '她冰箱里有三块奶酪。'],
    ['Skär osten tunt.', '把奶酪切薄。'],
  ]), 1602),
  freq(noun('trappa', 'en', '楼梯', 'stairs / staircase', 'trappan', 'trappor', 'trapporna', [
  ...
  freq(noun('kanon', 'en', '大炮；大腕（口）', 'cannon / (informal) big shot', 'kanonen', 'kanoner', 'kanonerna', [
  ...
  freq(noun('storlek', 'en', '尺寸；大小；号', 'size', 'storleken', 'storlekar', 'storlekarna', [
  ...
  freq(noun('apa', 'en', '猴子；猿；爱模仿的人', 'monkey / ape', 'apan', 'apor', 'aporna', [
  ...
  freq(noun('gris', 'en', '猪；邋遢的人（贬）', 'pig', 'grisen', 'grisar', 'grisarna', [
  ...
  freq(noun('mobil', 'en', '手机', 'mobile phone', 'mobilen', 'mobiler', 'mobilerna', [
  ...
  freq(noun('morbror', 'en', '舅舅；姨父', 'maternal uncle', 'morbrodern', 'morbröder', 'morbröderna', [
  ...
  freq(noun('utbildning', 'en', '教育；培训', 'education / training', 'utbildningen', 'utbildningar', 'utbildningarna', [
  ...
  freq(noun('faster', 'en', '姑姑；伯母', 'paternal aunt', 'fastern', 'fastrar', 'fastrarna', [
  ...
  freq(noun('tisdag', 'en', '星期二', 'Tuesday', 'tisdagen', 'tisdagar', 'tisdagarna', [
  ...
  freq(noun('hiss', 'en', '电梯', 'lift / elevator', 'hissen', 'hissar', 'hissarna', [
    ['Vi tar hissen upp.', '我们坐电梯上去。'],
    ['Hissen är trasig idag.', '电梯今天坏了。'],
    ['Huset har två hissar.', '这房子有两部电梯。'],
    ['Vänta vid hissen.', '在电梯那儿等。'],
  ]), 1636),
  freq(noun('maskin', 'en', '机器', 'machine', 'maskinen', 'maskiner', 'maskinerna', [
  ...
  freq(noun('bas', 'en', '基础；基地；低音；头儿', 'base / foundation / bass / boss', 'basen', 'baser', 'baserna', [
  ...
  freq(noun('jacka', 'en', '夹克；短外套', 'jacket', 'jackan', 'jackor', 'jackorna', [
  ...
  freq(noun('kopia', 'en', '副本；复印件；复制品', 'copy', 'kopian', 'kopior', 'kopiorna', [
  ...
  freq(noun('port', 'en', '大门；门洞；街门', 'gate / street door / doorway', 'porten', 'portar', 'portarna', [
